...
// import SEO from '../components/SEO'; // SEO is used in pages, not layout directly here? Or was it? 
// Checking App.tsx, SEO import was unused in the visible code but present.
...
const MainLayout: React.FC = () => {
    ...
    useEffect(() => {
        ...
        // Check if pathParts[1] exists and is a valid language
        ...
        // If we are here, it means we might be on a non-language route that is handled by this layout.
        // However, MainLayout is primarily for the main site which uses /:lang.
