                  ...
                  {events.map((event) => (
                     ...
                     >
                        <div className="flex gap-6">
                           ...
                           <div>
                              <h4 className="font-display text-xl mb-2 dark:text-white group-hover:text-teal transition-colors">{event.title}</h4>
                              <p className="text-xs text-graphite/50 dark:text-white/40 font-serif line-clamp-2 italic">{event.description}</p>
                  ...
                  {projects.map((project) => (
                     ...
                     >
                        ...
                        <div className="md:w-2/3 flex flex-col justify-center">
                           ...
                           <h4 className="font-display text-xl mb-2 dark:text-white group-hover:text-teal transition-colors">{project.title}</h4>
                           <p className="text-xs text-graphite/50 dark:text-white/40 font-serif italic mb-4">{project.location}</p>
