            ...
            <div className="lg:col-span-7">
              {MOCK_ARTICLES.length > 0 ? (
                <div
                  ...
                  onClick={() => onItemClick({ ...MOCK_ARTICLES[0], type: 'article' })}
                >
            ...
            <div className="lg:col-span-5 space-y-12 lg:pt-10">
              <div className="space-y-10">
                ...
                {MOCK_ARTICLES.length > 1 ? MOCK_ARTICLES.slice(1, 4).map((art, idx) => (
                  <div key={art.id} className="flex gap-6 group cursor-pointer transition-all hover:pl-4 border-l border-transparent hover:border-teal" onClick={() => onItemClick({ ...art, type: 'article' })}>
