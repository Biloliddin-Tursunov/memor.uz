...
import { findProject } from '../../constants';
...
export const ProjectDetail: React.FC<{ language: Language }> = ({ language }) => {
  ...
  if (!project) return <div className="p-20 text-center">Loyiha topilmadi.</div>;
  ...
  return (
    <div className="w-full animate-in fade-in duration-700 bg-parchment dark:bg-[#020617]">
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 pt-8 mb-6">
        ...
        >
          <span className="group-hover:-translate-x-1 transition-transform">&larr;</span> {language === 'uz' ? 'Loyihalarga qaytish' : 'Back to projects'}
        </button>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 py-16 grid grid-cols-1 lg:grid-cols-12 gap-12">
        <div className="lg:col-span-8">
          <div className="flex items-center gap-4 mb-8">
            <h2 className="font-display text-2xl dark:text-white uppercase tracking-wide">Tavsif</h2>
          ...
          <div className="prose prose-lg dark:prose-invert font-serif text-graphite/80 dark:text-slate-300 max-w-none">
            ...
            <p className="leading-relaxed mb-10">
              Ushbu loyiha Me'mor jamoasining uzoq yillik izlanishlari mahsulidir. Biz har bir detalda tarixiy haqiqiylikni saqlab qolgan holda, zamonaviy hayot talablariga javob beradigan muhandislik yechimlarini qo'lladik. Bu nafaqat bino, balki madaniy merosning davomidir.
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 my-12">
              <div className="aspect-[4/3] bg-graphite/5 dark:bg-white/5 border border-graphite/10 dark:border-white/10 flex flex-col items-center justify-center p-6 text-center">
                ...
                <span className="text-[10px] font-mono uppercase tracking-widest text-graphite/40">[ Texnik Chizma A-01 ]</span>
              </div>
              <div className="aspect-[4/3] bg-graphite/5 dark:bg-white/5 border border-graphite/10 dark:border-white/10 flex flex-col items-center justify-center p-6 text-center">
                <Ornament type="tile-header" className="w-16 h-8 mb-4 opacity-20" />
                <span className="text-[10px] font-mono uppercase tracking-widest text-graphite/40">[ Materiallar Fakturasi ]</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="lg:col-span-4">
          <div className="sticky top-32 space-y-8 bg-white dark:bg-white/5 p-8 border border-graphite/5 shadow-sm">
            <div className="border-l-2 border-sepia pl-6">
              <h3 className="font-display text-lg mb-4 dark:text-white uppercase tracking-widest">Ma'lumotlar</h3>
              <ul className="space-y-4 text-[11px] font-mono text-graphite/50 dark:text-white/40 uppercase tracking-[0.2em]">
                <li className="flex justify-between"><span>Boshlanishi</span> <span className="text-graphite dark:text-white">2024</span></li>
                <li className="flex justify-between"><span>Turi</span> <span className="text-graphite dark:text-white">Restavratsiya</span></li>
                <li className="flex justify-between"><span>Hajmi</span> <span className="text-graphite dark:text-white">1,200 m²</span></li>
                <li className="flex justify-between"><span>Jamoa</span> <span className="text-graphite dark:text-white">12 Ekspert</span></li>
              </ul>
            </div>
