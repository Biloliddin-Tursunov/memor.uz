...
export const TRANSLATIONS = {
  uz: {
    ...
    themeLight: 'Yorug\'',
    themeDark: 'Tungi',
    copyright: `\u00A9 ${new Date().getFullYear()} ME'MOR. BARCHA HUQUQLAR HIMOYALANGAN.`,
    pillarsTitle: 'ASOSIY USTUNLAR',
    ilmTitle: 'ILM MASKANI',
    ilmDesc: 'Arxitektura va san\'atga oid nodir kitoblar va manbalar jamlangan xazina.',
    ilmLink: 'KUTUBXONAGA KIRISH',
    amaliyotTitle: 'AMALIYOT MAYDONI',
    amaliyotDesc: 'Haqiqiy loyihalar, qurilish jarayonlari, maqolalar va videodarslar — bizning amaliy harakatlarimiz.',
  ...
  en: {
    ...
    themeLight: 'Light',
    themeDark: 'Dark',
    copyright: `\u00A9 ${new Date().getFullYear()} ME'MOR. ALL RIGHTS RESERVED.`,
    pillarsTitle: 'CORE PILLARS',
    ilmTitle: 'HOUSE OF KNOWLEDGE',
    ilmDesc: 'A treasury of rare books and sources on architecture and art.',
    ilmLink: 'ENTER LIBRARY',
    amaliyotTitle: 'FIELD OF PRACTICE',
    amaliyotDesc: 'Real projects, construction processes, articles, and video lessons — our practical actions.',
    ...
    viewAll: 'View All',
    beautifyWorld: '"To beautify the world ..."',
    projectYear: 'ME\'MOR • 2025',
  ...
  ru: {
    ...
    themeLight: 'Светлая',
    themeDark: 'Темная',
    copyright: `\u00A9 ${new Date().getFullYear()} ME'MOR. \u0412\u0421\u0415 \u041F\u0420\u0410\u0412\u0410 \u0417\u0410\u0429\u0418\u0429\u0415\u041D\u042B.`,
    pillarsTitle: 'ОСНОВНЫЕ СТОЛПЫ',
    ilmTitle: 'ОБИТЕЛЬ ЗНАНИЙ',
    ilmDesc: 'Сокровищница редких книг и источников по архитектуре и искусству.',
    ilmLink: 'ВОЙТИ В БИБЛИОТЕКУ',
    amaliyotTitle: 'ПОЛЕ ПРАКТИКИ',
    amaliyotDesc: 'Реальные проекты, процессы строительства, статьи и видеоуроки — наши практические действия.',
    ...
    beautifyWorld: '"\u0427\u0442\u043E\u0431\u044B \u0443\u043A\u0440\u0430\u0441\u0438\u0442\u044C \u043C\u0438\u0440 ..."',
    projectYear: 'ME\'MOR • 2025',
  ...
  tr: {
    ...
    themeLight: 'Aydınlık',
    themeDark: 'Karanlık',
    copyright: `\u00A9 ${new Date().getFullYear()} ME'MOR. T\u00DCM HAKLARI SAKLIDIR.`,
    pillarsTitle: 'TEMEL SÜTUNLAR',
    ilmTitle: 'İLİM KÖŞKÜ',
    ilmDesc: 'Mimarlık ve sanata dair nadir kitaplar ve kaynakların toplandığı hazine.',
    ilmLink: 'KÜTÜPHANEYE GİRİŞ',
    amaliyotTitle: 'UYGULAMA ALANI',
    amaliyotDesc: 'Gerçek projeler, inşaat süreçleri, makaleler ve video dersler — bizim pratik hareketlerimiz.',
    ...
    viewAll: 'Hepsini Gör',
    beautifyWorld: '"D\u00FCnyay\u0131 g\u00FCzelle\u015Ftirmek i\u00E7in ..."',
    projectYear: 'ME\'MOR • 2025',
