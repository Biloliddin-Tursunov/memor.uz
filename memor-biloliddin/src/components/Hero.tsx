      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        ...
        <div className="flex flex-col md:flex-row items-center gap-10 md:gap-20">
          ...
          <div className="w-full md:w-5/12 flex justify-center md:justify-end animate-fade-in order-1 md:order-1">
            <div className="relative w-72 md:w-96 aspect-[3/4] bg-white p-2 shadow-xl rounded-sm rotate-2 hover:rotate-0 transition-transform duration-700 border border-sepia/20">
          ...
          <div className="w-full md:w-7/12 text-center md:text-left space-y-6 animate-fade-in-up delay-100 order-2 md:order-2">
            <div>
              <span className="text-sepia font-sans uppercase tracking-widest text-xs font-semibold block mb-2">
                a person on the journey of life
              </span>
              <h1 className="font-serif text-4xl md:text-6xl text-deep-teal leading-tight">
                Salom DUNYO <br /> bu <span className="italic text-sepia">Men</span>.
              </h1>
            </div>
            ...
            {/* Social Icons */}
            <div className="flex justify-center md:justify-start space-x-6 py-2">
              {personalInfo.socials && Object.entries(personalInfo.socials).map(([key, url]) => (
                <a key={key} href={url} target="_blank" rel="noopener noreferrer" className="text-deep-teal hover:text-sepia transition-transform hover:scale-110">
                  {key === 'instagram' && (
                  ...
                  {key === 'telegram' && (
                    <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24"><path d="M11.944 0a12 12 0 0 0-12 12 12 12 0 0 0 12 12 12 12 0 0 0 12-12 12 12 0 0 0-12-12zm3.47 16.94l-1.48-1.22-3.18 3.58a.46.46 0 0 1-.77-.33l-.11-3.69-5.11-1.62a.49.49 0 0 1 .05-.93l13.62-5.71a.48.48 0 0 1 .63.63l-3.65 9.29zM16.94 6.74l-11.47 4.79 3.65 1.15 8.18-5.78c.08-.06.2.03.13.11l-6.84 6.8-.07 2.27 1.83-1.39 3.12 2.56 1.13-7.51z" /></svg>
                  )}
                  {key === 'github' && (
