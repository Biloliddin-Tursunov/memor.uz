        ...
        <div className="flex flex-col h-full pt-2">
            ...
            <div className="relative flex-1 bg-slate-200 rounded-xl border border-slate-300 overflow-hidden shadow-inner group min-h-[300px]">
                ...
                <div className="absolute top-4 left-4 right-4 md:w-80">
                    <div className="bg-white rounded-lg shadow-sm flex items-center p-1.5 border border-slate-300">
                        ...
                        <input
                            ...
                            className="w-full px-2 py-1 outline-none text-sm text-slate-800 placeholder-slate-400"
                        />
                    </div>
                </div>
                ...
                <div className="absolute bottom-4 right-4 flex flex-col gap-2">
                    <button className="w-9 h-9 bg-white border border-slate-200 rounded-lg shadow-sm flex items-center justify-center hover:bg-slate-50 text-slate-700">
                        <Plus size={18} />
                    </button>
                    <button className="w-9 h-9 bg-white border border-slate-200 rounded-lg shadow-sm flex items-center justify-center hover:bg-slate-50 text-slate-700">
                        <Minus size={18} />
